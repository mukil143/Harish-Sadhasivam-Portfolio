...
const Technologies = () => {
  return (
    <div className= " h-screen border-b text-center flex flex-col  items-center border-neutral-900 pb-24  ">
            <h2 className='text-4xl text-center my-20 font-thin'>Technologies</h2>
        <div className="grid grid-cols-2  md:grid-cols-4 gap-4 w-fit  items-center justify-center  transition-all duration-1000 ">
