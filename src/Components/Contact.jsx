  ...
  return (
    <section className='pb-12 h-screen dark:bg-dark'>
      <div className='container '>
        <div className='-mx-4 flex  b items-center justify-center flex-wrap'>
          <DefaultColumn>
...
{showtoast?(
    ...
    <div class="ps-4 text-sm font-normal">Message sent {isSent? " successfully" : "Sending...."}</div>
</div>
):""}
...
const DefaultColumn = ({ children }) => {
  return (
    <div className='w-full border mt-10 md:mt-20 rounded-lg  px-10 md:w-1/2 lg:w-1/3'>
