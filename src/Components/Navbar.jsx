    ...
    <nav className="mb-14  flex items-center   justify-between  py-6">
      ...
      <ul className=" my-8 text-white flex items-center justify-center gap-4 *:cursor-pointer text-2xl">
        <li className="">
          <a
            target="_blank"
            href="https://www.linkedin.com/in/harish-s-066033179/"
          >
            <FaLinkedin />
          </a>
        </li>
        <li>
          <a target="_blank" href="https://github.com/harishsthedeveloper">
            <FaGithub />
          </a>
        </li>
        <li>
          <a target="_blank" href="https://www.instagram.com/_s_h_a_r_i_s_h_/?__pwa=1#">
            <FaInstagram />
          </a>{" "}
        </li>
        <li>
          {" "}
          <a href="mailto:erodeharish07@gmail.com?subject=Hello&body=Hi there!">
            <FaEnvelope />
          </a>
        </li>
      </ul>
